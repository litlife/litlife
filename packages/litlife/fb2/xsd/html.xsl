...
<X:stylesheet xmlns:X="http://www.w3.org/1999/XSL/Transform"
                                ...
                                <X:choose>
                                    <X:when test="starts-with(/F:FictionBook/F:description/F:title-info/F:coverpage/F:image/@L:href,'#')">
                                        <X:attribute name="src">
                                            <X:value-of
                                                    select="concat($imgprefix,substring(/F:FictionBook/F:description/F:title-info/F:coverpage/F:image/@L:href,2))"/>
                                        </X:attribute>
                                    </X:when>
                                    <X:otherwise>
                                        <X:attribute name="src">
                                            <X:value-of
                                                    select="concat($imgprefix,/F:FictionBook/F:description/F:title-info/F:coverpage/F:image/@L:href)"/>
                                        </X:attribute>
                                    </X:otherwise>
                                </X:choose>
                            </img>
                    ...
                    <ul>
                        ...
                        <X:if test="$includedesc">
                            <X:if test="/F:FictionBook/F:description/F:title-info/F:annotation">
                                <li>
                                    <p>
                                        <a class="toclink" href="#_fbh_annotation">Annotation</a>
                                    </p>
                                </li>
                            </X:if>
                            <li>
                                <p>
                                    <a class="toclink" href="#_fbh_description">Document information</a>
                                </p>
                            </li>
                        </X:if>
                    </ul>
    ...
    <X:template name="sb-title">
        ...
        <X:choose>
            ...
            <X:when test="$level>4">
                <h4>
                    <X:call-template name="hx-title"/>
                </h4>
            </X:when>
            <X:otherwise>
                <!-- compute an appropriate heading element -->
                <X:element name="h{$level}">
                    <X:call-template name="hx-title"/>
                </X:element>
            </X:otherwise>
        </X:choose>
    ...
    <X:template match="F:title-info">
        ...
        <tr>
            <td>Genre
                <X:if test="count(F:genre) &gt; 1">s</X:if>
            </td>
            <td>
        ...
        <tr>
            <td>Author
                <X:if test="count(F:author) &gt; 1">s</X:if>
            </td>
            <td>
        ...
        <tr>
            <td>Title</td>
            <td>
                <X:value-of select="F:book-title"/>
            </td>
        </tr>
        ...
        <X:if test="F:translator">
            <tr>
                <td>Translator
                    <X:if test="count(F:translator) &gt; 1">s</X:if>
                </td>
                <td>
    ...
    <X:template match="F:document-info">
        ...
        <X:if test="F:program-used">
            <tr>
                <td>Program used</td>
                <td>
                    <X:value-of select="F:program-used"/>
                </td>
            </tr>
        </X:if>
        <X:apply-templates select="F:date"/>
        ...
        <tr>
            <td>ID</td>
            <td>
                <X:value-of select="F:id"/>
            </td>
        </tr>
        <tr>
            <td>Version</td>
            <td>
                <X:value-of select="F:version"/>
            </td>
        </tr>
        <X:if test="F:history">
            <tr>
                <td>History</td>
                <td>
                    <X:apply-templates select="F:history/*"/>
                </td>
            </tr>
        </X:if>
    </X:template>
    ...
    <X:template match="F:custom-info">
        <tr>
            <td>
                <X:value-of select="@info-type | @F:info-type"/>
            </td>
            <td>
                <X:value-of select="."/>
            </td>
        ...
        <X:if test="F:title | .//F:section/F:title">
            <li>
                ...
                <X:if test=".//F:section/F:title and count(ancestor::F:section) &lt; $tocdepth">
                    <ul>
                        <X:apply-templates select="F:section" mode="toc"/>
                    </ul>
                </X:if>
            </li>
        </X:if>
