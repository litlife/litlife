...
class RemoveOldColumns extends Migration
{
	...
	public function up()
	{
		...
		$this->dropTableIfExists('anchors');
		$this->dropTableIfExists('annotations');
		$this->dropTableIfExists('audits');
		...
		$this->dropTableIfExists('book_compilers');
		$this->dropTableIfExists('book_covers');
		$this->dropTableIfExists('book_editors');
		...
		$this->dropTableIfExists('book_illustrators');
		...
		$this->dropTableIfExists('book_similars');
		$this->dropTableIfExists('book_source_files');
		...
		$this->dropTableIfExists('book_translators');
		$this->dropTableIfExists('book_views');
		...
		$this->dropTableIfExists('coollib_blocklists');
		$this->dropTableIfExists('curse_words');
		$this->dropTableIfExists('download_counts');
		$this->dropTableIfExists('email_changes');
		$this->dropTableIfExists('email_confirms');
		...
		$this->dropTableIfExists('litres_books');
		$this->dropTableIfExists('lost_passwords');
		...
		$this->dropTableIfExists('moderator_requests');
		$this->dropTableIfExists('old_genres_groups');
		...
		$this->dropTableIfExists('user_status');
		...
		$this->dropTableIfExists('users_many_accounts');
	...
	public function dropColumnIfExists(Blueprint $table, $name)
	{
		if (mb_substr($name, 0, 4) != 'old_') {
			$name = 'old_' . $name;
		}
	...
	{
		Schema::dropIfExists('old_' . $table);
	}
