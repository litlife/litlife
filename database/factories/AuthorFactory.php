...
$factory->afterMakingState(App\Author::class, 'private', function (Author $author, $faker) {
    $author->statusPrivate();
});

$factory->afterMakingState(App\Author::class, 'accepted', function (Author $author, $faker) {
    $author->statusAccepted();
});

$factory->afterMakingState(App\Author::class, 'sent_for_review', function (Author $author, $faker) {
    $author->statusSentForReview();
});

$factory->afterCreatingState(App\Author::class, 'with_photo', function (Author $author, $faker) {
