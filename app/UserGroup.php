...
class UserGroup extends Model
{
    ...
    public $permissions =
        [
            ...
            'change_users_group' => false,
            // изменять группы у пользователей
            'manage_users_groups' => false,
            // добавлять, редактировать, удалять группы пользователей
            'user_moderate' => false,
            // удалять и добавлять пользователей на модерирование сообщений
            'user_delete' => false,
            // удалять и восстанавливать аккаунты пользователей
            'user_suspend' => false,
            // отключать и включать аккаунты пользователей

            'add_comment' => false,
            // добавлять комментарии
            'comment_self_edit_only_time' => false,
            // редактировать свои комментарии только в течениe  секунд
            'comment_edit_my' => false,
            // редактировать свои комментарии
            'comment_edit_other_user' => false,
            // редактировать чужие коментарии
            'delete_my_comment' => false,
            // удалять свои комментарии
            'delete_other_user_comment' => false,
            // удалять комментарии других пользователей
            'comment_view_who_likes_or_dislikes' => false,
            // просматривать кому понравился или не понравился комментарий
            //'vote_for_comment' => false, // голосовать за комментарии
            'comment_add_vote' => false,
            // голосовать за комментарии
            'book_comments_manage' => false,
            // открывать и закрывать комментарии к книгам

            'add_book' => false,
            // добавлять книги
            'add_book_without_check' => false,
            // добавлять книги без проверки
            'edit_self_book' => false,
            // редактировать свои книги
            'edit_other_user_book' => false,
            // редактировать книги чужих людей
            'delete_self_book' => false,
            // удалять свои книги
            'delete_other_user_book' => false,
            // удалять книги чужих людей
            'check_books' => false,
            // проверять книги
            'connect_books' => false,
            // соединять книги
            'book_secret_hide_set' => false,
            // закрывать/открывать доступ к книгам'
            'vote_for_book' => false,
            // оценивать книги / _удалять оценки
            'book_rate_other_user_remove' => false,
            // удалять чужие оценки

            'author_edit' => false,
            // редактировать автора
            'delete_hide_author' => false,
            // удалять авторов
            //'manage_author' => false, // управлять авторами
            'merge_authors' => false,
            // соединять авторов
            'author_group_and_ungroup' => false,
            // группировать и разгруппировывать авторов

            'sequence_delete' => false,
            // удалять/восстанавливать серии
            'sequence_edit' => false,
            // редактировать серии
            'sequence_merge' => false,
            // объединять серии

            'send_message' => false,
            // отправлять или редактировать личные сообщения
            'delete_message' => false,
            // удалять личные сообщения
            ...
            'author_repeat_report_add' => false,
            // сообщять о том, что автор поворяется
            'author_repeat_report_delete' => false,
            // удалять любые записи, что автор поворяется
            'author_repeat_report_edit' => false,
            // редактировать свои записи, что автор поворяется

            'forum_group_handle' => false,
            // добавлять, удалять, редактировать, перемещать группы форумов

            'add_forum_forum' => false,
            // добавлять форумы
            'forum_edit_forum' => false,
            // редактировать форумы
            'delete_forum_forum' => false,
            // удалять форумы
            'forum_list_manipulate' => false,
            // управлять списками форумов

            'add_forum_topic' => false,
            // добавлять темы
            'delete_forum_self_topic' => false,
            // удалять свои темы
            'delete_forum_other_user_topic' => false,
            // удалять темы чужих людей
            'edit_forum_self_topic' => false,
            // редактировать свои темы
            'edit_forum_other_user_topic' => false,
            // редактировать темы чужих людей
            'manipulate_topic' => false,
            // управлять темами

            'add_forum_post' => false,
            // добавлять сообщения

            'forum_edit_self_post_only_time' => false,
            // редактировать свои сообщения только в течениe  секунд
            'forum_edit_self_post' => false,
            // редактировать свои сообщения всегда
            'forum_edit_other_user_post' => false,
            // редактировать сообщения других пользователей
            'forum_delete_self_post' => false,
            // удалять свои сообщения
            'forum_delete_other_user_post' => false,
            // удалять сообщения чужих людей
            'forum_topic_merge' => false,
            // объединять темы
            //'forum_move_topic' => false, // перемещать темы
            'forum_move_post' => false,
            // перемещать посты + _показать кнопку _удалить отмеченные посты
            'forum_post_manage' => false,
            // управлять постами (закреплять и откреплять посты)

            'blog' => false,
            // включить блог
            'blog_other_user' => false,
            // управлять чужим блогом

            'moderator_add_remove' => false,
            // добавлять/удалять модераторов
            'author_editor_request' => false,
            // отправлять запросы "стать автором или редактором"
            'author_editor_check' => false,
            // проверять запросы "стать автором или редактором"

            //'book_manage' => false, // управлять книгами автора

            'book_file_add' => false,
            // добавлять файлы ко всем публичным книгам
            'book_file_add_without_check' => false,
            // без проверки
            'book_file_add_to_self_book_without_check' => false,
            // без проверки, только к своим книгам
            'book_file_add_check' => false,
            // проверять добавленные файлы книг
            'book_file_delete' => false,
            // удалять любые файлы книг
            'book_file_edit' => false,
            // редактировать описания файлов книг

            'book_keyword_add' => false,
            // Прикреплять существующие ключевые слова к книгам без проверки
            'book_keyword_add_new_with_check' => false,
            // Добавлять новые ключевые слова с проверкой
            'book_keyword_moderate' => false,
            // Проверять ключевые слова и добавлять новые без проверки
            'book_keyword_remove' => false,
            // удалять ключевые слова
            'book_keyword_edit' => false,
            // редактировать ключевые слова
            'book_keyword_vote' => false,
            // ставить оценки +/- ключевым словам

            'book_fb2_file_convert_divide_on_page' => false,
            // преобразовать fb2, epub файл в страницы онлайн чтения

            'book_similar_vote' => false,
            // добавлять или голосовать похожие книги
            ...
            'add_genre_to_blacklist' => false,
            // добавлять жанр в черный список

            'text_block' => false,
            // добавлять или редактировать текстовый блок
            'admin_comment' => false,
            // кому видны и кому можно редактировать заметки для администрации

            'complain' => false,
            // отправять жалобы
            'complain_check' => false,
            // обрабатывать жалобы
            'check_post_comments' => false,
            // проверять комментарии и сообщения на модерации
            'access_to_closed_books' => false,
            // досуп к закрытым книгам
            'admin_panel_access' => false,
            // досуп к панели настроек и различных функций сайта
            'retry_failed_book_parse' => false,
            // отправить книгу на повторную обработку, если ее добавление произошло с ошибкой
            'achievement' => false,
            // 'добавление, удаление, присваивание достижений
            'watch_activity_logs' => false,
            //'use_red_color' => false, //
            'display_technical_information' => false,
            'refresh_counters' => false,
            'awards' => false,
            // добавление, редактирование или удаление книжных наград
            'access_send_private_messages_avoid_privacy_and_blacklists' => false,
            // Доступ к отправке личных сообщений при ограничении приватности и в обход ЧС пользователя
            'shop_enable' => false,
