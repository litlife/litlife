...
class HandleOutgoingErrorPayments extends Command
{
	/**
	 ...
	 * @var string
	 */
	protected $signature = 'payments:handle_error_outgoing_payments';
	 ...
	 * @var string
	 */
	protected $description = 'Обрабатывает все выплаты с ошибками';
	...
	public function handle()
	{
		UserOutgoingPayment::whereHas('transaction', function ($query) {
			$query->where('status', PaymentStatusEnum::Error)
