...
class DeleteBookRatingIfUserDeleted extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'user:if_deleted_delete_ratings {days_passed=7} {user_id?}';
     ...
     * @var string
     */
    protected $description = 'Комманда удаляет оценки пользователей, аккаунты которых удалены, спустя несколько дней';
    ...
    public function item(User $user)
    {
        ...
        $user->votes()->chunkById(100, function ($votes) {
