 ...
 * @mixin Eloquent
 * @method static QueryBuilder|Section ancestorsAndSelf($id, array $columns = [])
 * @method static QueryBuilder|Section ancestorsOf($id, array $columns = [])
 * @method static QueryBuilder|Section applyNestedSetScope(?string $table = null)
 * @method static QueryBuilder|Section countErrors()
 * @method static QueryBuilder|Section defaultOrder(string $dir = 'asc')
 * @method static QueryBuilder|Section descendantsAndSelf($id, array $columns = [])
 * @method static QueryBuilder|Section descendantsOf($id, array $columns = [], $andSelf = false)
 * @method static QueryBuilder|Section fixSubtree($root)
 * @method static QueryBuilder|Section fixTree($root = null)
 * @method static QueryBuilder|Section getNodeData($id, $required = false)
 * @method static QueryBuilder|Section getPlainNodeData($id, $required = false)
 * @method static QueryBuilder|Section getTotalErrors()
 * @method static QueryBuilder|Section hasChildren()
 * @method static QueryBuilder|Section hasParent()
 * @method static QueryBuilder|Section isBroken()
 * @method static QueryBuilder|Section leaves(array $columns = [])
 * @method static QueryBuilder|Section makeGap(int $cut, int $height)
 * @method static QueryBuilder|Section moveNode($key, $position)
 * @method static QueryBuilder|Section orWhereAncestorOf(bool $id, bool $andSelf = false)
 * @method static QueryBuilder|Section orWhereDescendantOf($id)
 * @method static QueryBuilder|Section orWhereNodeBetween($values)
 * @method static QueryBuilder|Section orWhereNotDescendantOf($id)
 * @method static QueryBuilder|Section rebuildSubtree($root, array $data, $delete = false)
 * @method static QueryBuilder|Section rebuildTree(array $data, $delete = false, $root = null)
 * @method static QueryBuilder|Section reversed()
 * @method static QueryBuilder|Section root(array $columns = [])
 * @method static QueryBuilder|Section whereAncestorOf($id, $andSelf = false, $boolean = 'and')
 * @method static QueryBuilder|Section whereAncestorOrSelf($id)
 * @method static QueryBuilder|Section whereDescendantOf($id, $boolean = 'and', $not = false, $andSelf = false)
 * @method static QueryBuilder|Section whereDescendantOrSelf(string $id, string $boolean = 'and', string $not = false)
 * @method static QueryBuilder|Section whereIsAfter($id, $boolean = 'and')
 * @method static QueryBuilder|Section whereIsBefore($id, $boolean = 'and')
 * @method static QueryBuilder|Section whereIsLeaf()
 * @method static QueryBuilder|Section whereIsRoot()
 * @method static QueryBuilder|Section whereNodeBetween($values, $boolean = 'and', $not = false)
 * @method static QueryBuilder|Section whereNotDescendantOf($id)
 * @method static QueryBuilder|Section withDepth(string $as = 'depth')
 * @method static QueryBuilder|Section withoutRoot()
 */
