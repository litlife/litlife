...
return [
	...
	"book_file_extension" => "Поле \":attribute\" должно быть файлом одного из следующих типов: " . implode(', ', array_keys(config('litlife.allowed_mime_types'))) . "",
	...
	'book_file' => "В поле \":attribute\" должен быть указан файл одного из следующих типов: " . implode(', ', array_keys(config('litlife.allowed_mime_types'))),
	'zip' => "В поле \":attribute\" должен быть указан правильный zip архив ",
	'zip_book_file' => "В поле \":attribute\" должен быть указан zip архив, который содержит файл одного из следующих типов: " . implode(', ', config('litlife.book_allowed_file_extensions')),
