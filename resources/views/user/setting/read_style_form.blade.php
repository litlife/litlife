...
<form role="form" method="POST" class="read_style"
	...
	<div class="form-group{{ $errors->has('font') ? ' has-error' : '' }}">
		...
		<select id="font" name="font" class="form-control" data-default="{{ $default_style->font }}">
	...
	<div class="form-group{{ $errors->has('align') ? ' has-error' : '' }}">
		...
		<select id="align" name="align" class="form-control" data-default="{{ $default_style->align }}">
	...
	<div class="form-group{{ $errors->has('size') ? ' has-error' : '' }}">
		...
		<select id="size" name="size" class="form-control" data-default="{{ $default_style->size }}">
