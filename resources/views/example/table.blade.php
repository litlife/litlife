...
@section('content')
	...
	<div class="card">
		<div class="card-body pl-2 pr-2">
			...
			<table id="table" class="table table-striped table-hover table-sm" data-trim-on-search="true"
				   data-mobile-responsive="true" data-toggle="table"
				   style="font-size:0.9rem;"
				   data-order="[[ 0, &quot;asc&quot; ]]">
				<thead class="thead-light">
				<tr>
					<th class="small" data-sortable="true" data-order="asc" data-sorter="window.htmlSorter">Заголовок</th>
					<th class="small" data-sortable="true" data-order="desc" data-toggle="tooltip" data-placement="top"
					...
					@auth
						<th class="small" data-sortable="true" data-toggle="tooltip" data-placement="top"
					...
					<th class="small" data-sortable="true" data-sorter="window.htmlSorter" data-order="desc">Жанры</th>
					<th class="small" data-sortable="true" data-order="desc"
						data-toggle="tooltip" data-placement="top" title="Количество страниц"><i class="far fa-file"></i>
					</th>
					<th class="small" data-sortable="true" data-sorter="window.htmlSorter">Серии</th>
					<th class="small" data-sortable="true" data-order="asc" data-toggle="tooltip" data-placement="top"
						...
						<td>
							@if ((isset($book->genres)) and ($book->genres->count()))
								@foreach ($book->genres as $genre)
									<a href="{{ route('books', ['genre' => $genre->id]) }}">
										{{ $genre->name }}</a>{{ $loop->last ? '' : ', ' }}
								@endforeach
							@endif
						</td>
