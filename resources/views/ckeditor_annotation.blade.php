@push('ckeditor')
	...
	<script type="text/javascript">
		...
		CKEDITOR.plugins.addExternal('jqueryspellchecker', '/ckeditor/plugins/jqueryspellchecker/plugin.js');
		...
		for (let i = 0; i < elements.length; i++) {
			...
			CKEDITOR.replace(element, {
				...
				extraPlugins: "blockquote,note,magicline,sourcearea,filebrowser,showborders," +
					"contextmenu,table,uploadimage,image2,autoembed,autolink,clipboard,notification,undo," +
					"uploadwidget,widget,filetools,notificationaggregator,toolbar,button," +
					"lineutils,widgetselection,jqueryspellchecker,wordcount",
				...
				allowedContent: 'h1; h2; h3; h4; h5; h6; ' +
					...
					'div(u-title,u-empty-line,u-subtitle,u-annotation,u-date,u-epigraph,u-text-author,u-poem,u-stanza,u-cite,u-v,u-image-align-center,u-date)[class,id];' +
				...
				wordcount: {
					...
					maxWordCount: -1,
					maxCharCount: '{{ config('litlife.max_annotation_characters_count') }}',
					maxParagraphs: -1,
