...
class BBCodeTest extends TestCase
{
	...
	public function testAutoLink()
	{
		...
		$this->assertEquals('text <a class="bb" href="http://' . parse_url(config('app.url'), PHP_URL_HOST) . '">http://' . parse_url(config('app.url'), PHP_URL_HOST) . '</a> text',
			bb_to_html('text http://' . parse_url(config('app.url'), PHP_URL_HOST) . ' text'));

		$this->assertEquals('text <a class="bb" href="http://www.' . parse_url(config('app.url'), PHP_URL_HOST) . '">www.' . parse_url(config('app.url'), PHP_URL_HOST) . '</a> text',
