...
class UserEmailConfirmTest extends TestCase
{
    ...
    public function testIfAnotherConfirmedEmailExists()
    {
        ...
        $email_not_confirmed = UserEmail::factory()->not_confirmed()->create(['email' => $email_confirmed->email]);
    ...
    public function testDontEnableLoginByIDIfThereAreConfirmedMailboxesExists()
    {
        ...
        $email_confirmed2 = UserEmail::factory()->confirmed()->create(['user_id' => $email_confirmed->user->id]);
