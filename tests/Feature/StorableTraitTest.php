...
class StorableTraitTest extends TestCase
{
	...
	public function testName()
	{
		...
		$this->assertEquals('long_name._long_name._long_name._long_name._long_name._long_name._long_name._long_name._long_name._long_name._long_name._long_name._long_name._long_name._long_name._long_name._long_name', $file->name);
