...
class BookAddEpubTest extends TestCase
{
    ...
    public function testAddWithCyrylicFileNames()
    {
        ...
        $this->assertEquals('<p>text</p><p><img alt="изображение" src="'.$book->attachments()->first()->url.'" width="340" height="332"/><br/></p><p><a href="#u-section-2">ссылка</a><br/></p>',
            $text);
    ...
    public function testUpperCaseImageName()
    {
        ...
        $this->assertEquals('<p>text</p><p><img alt="изображение" src="'.$attachment->url.'" width="340" height="332"/><br/></p><p><a href="#u-section-2">ссылка</a><br/></p>',
            $text);
