...
class BookSqliteTest extends TestCase
{
    ...
    public function testBinaryInPageHttp()
    {
        ...
        $this->assertStringContainsString('text <img width="604" height="604" alt="'.$this->book->title.' test.jpeg" src="'.route('books.old.image',
                ['book' => $this->book, 'name' => 'test.jpeg']).'"> text',
            $response->getContent());
    }
