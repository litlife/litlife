...
class CollectionCommentSubscriptionToggleTest extends TestCase
{
    public function testToggleWithoutAjax()
    {
        ...
        $response = $this->actingAs($admin)
            ...
            ->assertOk()
            ->assertSeeText(__('collection.notifications_for_new_collection_comments_has_been_successfully_enabled',
        ...
        $this->actingAs($admin)
            ...
            ->get(route('collections.event_notification_subcriptions.toggle', $collection))
            ->assertOk()
            ->assertSeeText(__('collection.notifications_about_new_comments_to_the_collection_successfully_disabled',
                ['collection_title' => $collection->title]));
    }
}
