        ...
        return {
            ...
            onOk: function () {
                ...
                if (data.info) {
                    ...
                    table.getAttribute('cellSpacing') ? table.setStyle('border-spacing', table.getAttribute('cellSpacing') + "px") : table.removeStyle('border-spacing');

                    var tds = table.find('td');

                    for (i = 0; i < tds.count(); i++) {

                        table.getAttribute('cellpadding') ? tds.getItem(i).setStyle('padding', table.getAttribute('cellpadding') + "px") : tds.getItem(i).removeStyle('padding');
                    }

                    var ths = table.find('th');

                    for (i = 0; i < ths.count(); i++) {
                        table.getAttribute('cellpadding') ? ths.getItem(i).setStyle('padding', table.getAttribute('cellpadding') + "px") : ths.getItem(i).removeStyle('padding');
                    }
