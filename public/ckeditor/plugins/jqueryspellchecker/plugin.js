...
CKEDITOR.plugins.add('jqueryspellchecker', {
    ...
    config: {
        ...
        local: {
            requestError: 'Произошла ошбика по время отправки запроса',
            ignoreWord: 'Игнорировать слово',
            ignoreAll: 'Игнорировать все',
            ignoreForever: 'Добавить в словарь',
            loading: 'Загрузка...',
            noSuggestions: '(Предложений не найдено)'
        },
    },
    ...
    createSpellchecker: function () {
        ...
        t.spellchecker.on('check.success', function () {
            alert('Ни одной ошибки не найдено');
            t.destroy();
        });
